...
| `felix-market` | 🎯 Felix — Market Proxy & Commercial Viability | Companyness, first-impression, referral readiness, 6-test name scoring | Lisa (concept names), Paul (intellectual positioning that lacks entity-feel) |
